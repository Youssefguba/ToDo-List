    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                final AddTaskViewModel addTaskViewModel = ViewModelProviders.of(this, viewModelFactory)
                        .get(AddTaskViewModel.class);

                addTaskViewModel.getTasks().observe(this, new Observer<TaskEntry>() {
                    @Override
                    public void onChanged(TaskEntry taskEntry) {
                        Log.d(TAG, "Receiving database updates from LiveData ");
                        addTaskViewModel.getTasks().removeObserver(this);
